	...
	<div class="container">
		<div class="row">
			<div class="col-md">
				{#if statsDB}
					<p class="m-0">
						Letztes Vod Update: {formatRelative(parseISO(statsDB.last_vod_sync), new Date(), {
							locale: de
						})} Uhr
					</p>
					<p class="m-0">
						Letztes Emote Update: {formatRelative(parseISO(statsDB.last_emote_sync), new Date(), {
							locale: de
						})} Uhr
					</p>
				{/if}
			...
			<div class="col-md text-md-end my-2">
				...
				<a
					href="https://discord.gg/n5vmqaChttps://discord.gg/n5vmqaC"
					target="_blank"
					rel="noopener noreferrer"
					data-bs-toggle="tooltip"
					title="Discord"
				...
				<a
					href="https://github.com/AgileProggers/wubbl0rz-archiv"
					target="_blank"
					rel="noopener noreferrer"
					data-bs-toggle="tooltip"
					title="GitHub"
				...
				<a
					href="https://status.wubbl0rz.tv/status"
					target="_blank"
					rel="noopener noreferrer"
					data-bs-toggle="tooltip"
					title="Status Page"
