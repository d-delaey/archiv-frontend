    ...
    <div class="row d-flex align-items-center justify-content-center h-100">
        ...
        <div class="col-auto mx-3">
            <div class="fs-3 fw-bold">
                {#if trend}
                    {#if trend > 0}
                        <div class="m-0" data-bs-toggle="tooltip" data-bs-placement="top" title="im Vergleich zum vorherigen Monat">
                            +{trend}
                            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-arrow-up-right-square-fill" viewBox="0 0 16 16">
                    ...
                    {:else}
                        <div class="m-0" data-bs-toggle="tooltip" data-bs-placement="top" title="im Vergleich zum vorherigen Monat">
                            {trend}
                            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-arrow-down-right-square-fill" viewBox="0 0 16 16">
